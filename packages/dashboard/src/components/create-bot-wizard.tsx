...
import type { GrvtNetwork, ValidateBotInput, ValidateBotResult } from '@/lib/api-types';
...
function StepConfirm({
  ...
  return (
    <div className="space-y-4">
      ...
      <SummaryGrid>
        <SummaryItem label="Mercado" value={(validated.grvt_network ?? state.grvtNetwork).toUpperCase()} mono={false} />
